...
{
    public static AudioClip DEATHOOF, BOSSOOF, DEEPOOF, 
        OOF, QUICKOOF, DODGE, ALARM, ARENEMY, PISTOLENEMY, 
        EXPLODE, BOSSSHOT, CHARGEUP, ELEVATORMOVE, ELEVATOROPEN, 
        MELEESTAB, MENUHOVER, MENUSELECT, PICKUP, ROBOTAIM, 
        ROBOTMOVE, SWITCH, TELEPORT, WHOOSH, SWORD;
