...
public class TurretScript : MonoBehaviour
{
    ...
    IEnumerator Shoot()
    {
        ...
        while (shooting)
        {
            ...
            if (gameObject.transform.rotation.y == 1 && gameObject.transform.position.x > player.transform.position.x || gameObject.transform.rotation.y == 0 &&  gameObject.transform.position.x < player.transform.position.x)
            {
